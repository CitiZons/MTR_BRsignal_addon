...
public final class ClientSetup {
	...
	public static void onReloadListeners(RegisterClientReloadListenersEvent event) {
		event.registerReloadListener((ResourceManagerReloadListener) manager -> org.mtrbr.render.SpeedSignRenderer.clearCache());
	...
	public static void onClientSetup(FMLClientSetupEvent event) {
		BlockEntityRenderers.register(org.mtrbr.SpeedSigns.ENTITY.get(), org.mtrbr.render.SpeedSignRenderer::new);
