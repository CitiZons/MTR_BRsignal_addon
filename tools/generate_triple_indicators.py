...
No new textures: the source materials are flat colours, sampled inside an opaque texel.
...
def build_rotations_and_shapes():
    java = ["package org.mtrbr.block;", "", "import net.minecraft.world.level.block.Block;",
            ...
            "public final class TripleIndicatorShapes {", "\tprivate TripleIndicatorShapes() {}"]
    for prefix in COMBINATIONS:
    ...
    java.append("}")
    (ROOT / "src/main/java/org/mtrbr/block/TripleIndicatorShapes.java").write_text("\n".join(java) + "\n", encoding="utf-8")
